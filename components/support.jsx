      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center space-y-12 md:space-y-0 md:space-x-8">
        <div className="flex-1">
          ...
          <p className="text-black leading-relaxed mb-8 mt-8">
            ...
            modi quos possimus reiciendis. Vero eaque eius facilis architecto
            corporis? Iste dolor totam quia doloremque numquam voluptates
            pariatur perferendis itaque illo!
          </p>
